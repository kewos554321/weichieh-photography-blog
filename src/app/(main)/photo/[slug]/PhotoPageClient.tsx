...
import { PhotoJsonLd, BreadcrumbJsonLd } from "@/components/JsonLd";
...
export default function PhotoPageClient({ slug }: { slug: string }) {
  ...
  return (
    <div className="pt-14 md:pt-16">
      ...
      <BreadcrumbJsonLd
        items={[
          { name: "Photos", url: BASE_URL },
          { name: photo.category, url: `${BASE_URL}/?category=${photo.category}` },
          { name: photo.title, url: `${BASE_URL}/photo/${photo.slug}` },
        ]}
      />
