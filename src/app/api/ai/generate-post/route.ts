...
1. **title**: An engaging post title (10-25 words)
2. **slug**: URL-friendly identifier (lowercase, hyphens, e.g., golden-hour-photography-tips)
3. **excerpt**: Post summary (50-100 words, for preview)
...
6. **content**: Full post content (Markdown format, 800-1500 words)
  ...
  "content": "## Section 1\\n\\nContent...\\n\\n## Section 2\\n\\nContent..."
    ...
    const userPrompt = prompt
      ...
      : language === "zh"
        ...
        : hasImages ? "Please write a photography blog post based on the photos" : "Please write a photography blog post";
